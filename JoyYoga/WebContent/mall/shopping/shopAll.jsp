...
/* 추천상품 */
.good_items { text-align: center; font-family: 'Hi Melody', cursive; }
...
/*
// 메인1: 신상품(100번대와 300번대에서 신상품 3개씩을 리스트에 담아서 리턴)
String[] nProducts = {"110", "120", "210", "220", "230", "310"};
List<ProductDTO> newProductList = productDAO.getProductList(nProducts, 1);
*/
// 메인2: 추천상품(모든 상품에서 최신상품 1개씩을 리스트에 담아서 리턴)
String[] nProducts2 = {"110", "120", "210", "220", "230", "310", "320", "330", "340", "410", "420", 
		"430", "440", "510"};
...
<div id="container">
	...
	<div> <%-- 메인(본문) --%>
		<main>
			...
			--%>
			<article class="good_items"> <%-- 메인2: 추천상품(모든 상품에서 신상품 1개씩을 가져와서 bx-slider으로 노출)--%>
				<h3>추천상품</h3>
				<div class="slider">
				<%for(ProductDTO product : goodProductList){%>
					<a href="shopContent.jsp?product_id=<%=product.getProduct_id()%>"><img src="/images_joyyoga/<%=product.getProduct_image1()%>" width="250" height="250" class="c_good_img"></a>
				<%}%>
				</div>
			</article>
			<hr>
