...
/* 상단 - 메인, 서브 타이틀 */
.t_title { font-family: 'Hi Melody', cursive; font-size: 2em; text-align: center; margin: 20px; }
/* 중단 - 입력창 */
...
.f_input .f_chk { text-align: left; margin: 10px 0 0 10px; font-size: 0.9em; color: gray; padding-left: 10px;font-family: 'Hi Melody', cursive; }
.f_input #btn_login { width: 425px; height: 47px; background: black; color: white; 
font-size: 16px; font-weight: bold; cursor: pointer; margin-top: 25px; margin-bottom: 10px; border: none; font-family: 'Hi Melody', cursive;}
/* 하단 - 비밀번호 찾기, 아이디 찾기, 회원가입 */
.f_a { text-align: center; margin-top: 30px; font-size: 0.9em; font-family: 'Hi Melody', cursive; }
.f_a a { color: gray; }
...
<script>
	document.addEventListener("DOMContentLoaded", function() {
		...
		// 쿠키가 생성되어 있을 때 쿠키에 저장된 값인 아이디를 아이디 입력상자에 넣도록 하는 작업
		// 쿠키 확인 - 쿠키가 존재한다면
		...
		// cookie 연결정보를 클라이언트 쪽에 저장, session: 연결정보를 서버 쪽에 저장 
