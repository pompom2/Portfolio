...
<head>
<meta charset="UTF-8">
<title>구매 아이디 별 상세 보기</title>
<style>
.container { width: 1200px; margin: 0 auto;}
.buy_datail { width: 100%;}
/* 중단 - d4 (구매목록) */
...
.d1 .t1 th { background: #dd7c9c; color: #fff; text-shadow: 1px 1px 1px gray;}
...
<div class="container">
	...
	<div class="buy_datail">
		<div class="d1">
			<table class="t1">
				<tr>
					<th width="15%">주문일자(주문번호)</th>
					<th colspan="2" width="40%">주문상품</th>
					<th width="10%">구매금액</th>
					<th width="10%">구매수량</th>
					<th width="10%">총 금액</th>
					<th width="15%">주문상태</th>
				...
				<tr>
					...
					<td width="32%" class="left"><span class="s3"><a href="../shopping/shopContent.jsp?product_id=<%=buy.getProduct_id()%>"><%=buy.getProduct_name() %></a></span></td>
			...
			<table class="t2">
				...
				<tr class="tr2">
					<td class="center" width="40%">
						<span class="s1">총 구매 상품 종류: <%=cnt1 %> 종<br>구매 상품 수량: <%=cnt2 %>개</span>
					</td>
