...
<script>
	document.addEventListener("DOMContentLoaded", function() {
		...
		btn_delete_bank.addEventListener("click", function() {
			...
			if(part == 1 || part == 2) {
				location = "../bank/bankDeletePro.jsp?product_id="+product_id+
						"&buy_count="+buy_count+"&card_no="+card_no+"&part="+part;
			} else if(part == 3) {
				location = "../bank/bankDeletePro.jsp?cart_id="+cart_id+
						"&card_no="+card_no+"&part="+part;
			}
		...
		btn_regist_bank.addEventListener("click", function() {
			...
			location = "../bank/bankInsertPro.jsp?cart_id="+cart_id+
					"&card_no="+card_no+"&card_com="+card_com+"&member_id="
					+member_id+"&member_name="+member_name+"&part="+part;
		})
			...
			<table class="t1">
				...
				<tr>
					<td width="10%" class="center">
						<a href="../shopping/shopContent.jsp?product_id=<%=cart.getProduct_id()%>"><img src="/images_joyyoga/<%=cart.getProduct_image1()%>" width="60" height="90"></a>
					</td>
