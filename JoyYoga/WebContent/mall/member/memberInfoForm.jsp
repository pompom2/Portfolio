...
/* 상단 - 메인, 서브 타이틀 */
.t_title { font-family: 'Hi Melody', cursive;  font-size: 1.7em; text-align: center; margin: 20px 0; }
/* 중단 - 입력 테이블 */
...
.c_id { background: #ccc; }
.s_id { color: red; font-size: 0.9em; font-family: 'Hi Melody', cursive; }
