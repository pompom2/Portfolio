...
a { text-decoration: none; color: #8ce5cb; }
input[type="text"], input[type="password"] { height: 18px; }
/* 상단 - 메인, 서브 타이틀 */
.t_title { font-family: 'Hi Melody', cursive; font-size: 1.7em; text-align: center; margin: 30px 0; }
/* 중단 - 입력 테이블 */
table { width: 500px; border: 1px solid black; border-collapse: collapse; margin: 0 auto; font-family: 'Hi Melody', cursive;}
tr { height: 65px; }
th, td { border: 1px solid black; padding-left: 5px; }
th { background: lightgray; }
.addr_row { height: 100px; }
.addr_row input { margin: 2px 0;}
#btn_chk_id{ width: 100px; height: 28px; border: none; background: black; color: white; font-size: 12px; 
cursor: pointer; border-radius: 30px; margin-left: 1px; font-family: 'Hi Melody', cursive;}
#btn_address { width: 100px; height: 28px; border: none; background: black; color: white; font-size: 12px; 
cursor: pointer; border-radius: 30px; font-family: 'Hi Melody', cursive;}
table span { font-size: 0.8em; font-family: 'Hi Melody', cursive;}
/* 하단 - 가입, 취소 버튼 */
...
font-size: 14px; font-weight: bold; cursor: pointer; font-family: 'Hi Melody', cursive;}
...
<script>
	...
	document.addEventListener("DOMContentLoaded", function() {
		...
		btn_chk_id.addEventListener("click", function() {
			if(form.id.value.length < 4) { // 아이디를 4글자 이상 입력했을 때 
		...
		// 비밀번호 확인 - pwd2
		// 비밀번호와 비밀번호 확인이 내용이 동일한지 유무를 판단
